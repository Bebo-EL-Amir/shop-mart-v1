...
<>
  <div className="w-full h-8 flex items-center px-3 my-3">
      ...
      <div className="w-full flex justify-between">
        ...
        <p className="ml-3 text-gray-500"><Link to={'post-details/'+postId}>{commentsNum} Comment</Link></p>
      </div>
    </div>
    <div className="grid grid-cols-3 w-full border-t border-divider pt-4 px-5 my-3">
